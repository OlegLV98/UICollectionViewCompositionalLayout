...
final class EventsHeaderCell: UICollectionReusableView, SelfConfiguringSupplementaryView {
    static let reuseId = "EventsHeaderCell"
...
extension EventsHeaderCell {
    func setConstraints() {
        NSLayoutConstraint.activate([
            hStack.topAnchor.constraint(equalTo: topAnchor),
            hStack.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 13),
            hStack.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -28),
